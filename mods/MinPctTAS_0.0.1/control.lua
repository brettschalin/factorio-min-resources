	...
	if queues.is_empty("character_action") and current_action == nil and
	   ...
	   queues.is_empty("lab") and current_tech == nil then
		...
		if first_tick then
			...
			p.set_quick_bar_slot(3, "rocket-fuel")
			p.set_quick_bar_slot(4, "speed-module")
			p.set_quick_bar_slot(5, "rocket-control-unit")
			p.set_quick_bar_slot(11, "coal")
			p.set_quick_bar_slot(12, "plastic-bar")
			p.set_quick_bar_slot(13, "copper-cable")
			p.set_quick_bar_slot(14, "iron-stick")
			p.set_quick_bar_slot(15, "concrete")
			p.set_quick_bar_slot(16, "iron-gear-wheel")
			p.set_quick_bar_slot(17, "inserter")
			p.set_quick_bar_slot(18, "engine-unit")
			p.set_quick_bar_slot(19, "rail")
			p.set_quick_bar_slot(20, "electric-engine-unit")
			...
			p.set_quick_bar_slot(27, "transport-belt")
			p.set_quick_bar_slot(28, "sulfur")
			p.set_quick_bar_slot(29, "productivity-module")
			p.set_quick_bar_slot(30, "flying-robot-frame")
			...
			p.set_quick_bar_slot(39, "electric-furnace")
			p.set_quick_bar_slot(40, "low-density-structure")
